...
const Bscscan = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            <h1 className='text-3xl mb-8 mt-2 font-bold'>BSCSCAN</h1>
            <form className='flex flex-col justify-center items-center' onSubmit={handleSubmit}>
                <textarea rows="10" cols="50" className='border-4 border-gray-400' spellCheck="true" name='input' />
                <div className='flex justify-between'>
                    <input type="file" name="inputByTxt" className='mt-4 p-2' />
                    <div className='flex justify-center p-2'>
                        <label for="countries" className="block text-sm font-medium text-gray-900 leading-[3.25rem] mx-2 ">Select a coin</label>
                        <select name='typeCoin' className='border-2 px-2 py-1 my-2 rounded-lg'>
            ...
            <div>
                {accoutHaveCoinList.length > 0 ? <table ref={tableRef} className='w-96'>
                ...
                </table> : <div> Don&lsquo;t have any data!</div>}
            </div>
